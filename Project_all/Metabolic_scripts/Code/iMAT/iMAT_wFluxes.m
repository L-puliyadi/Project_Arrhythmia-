function tissueModel = iMAT_wFluxes(model, expressionRxns, threshold_lb, threshold_ub, tol, core, logfile, runtime, epsilon)
...
if nargin < 5 || isempty(core)
    ...
    tissueModel.x = solution.cont(abs(solution.cont) >= tol);
end
